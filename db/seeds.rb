...
jacobi = Polynomial.new({
  ...
  definition: 'P_n^{(\alpha,\beta)}(x) = \frac{1}{2^n} \sum_{k=0}^n {n+\alpha \choose k} {n+\beta \choose n-k} \left(x-1\right)^{n-k} \left(x+1\right)^{k} = {n+\beta \choose \beta} \left(\frac{x-1}{2}\right)^n {}_2F_1 \left(\left. {-n, -n-\alpha \atop \beta+1} \; \right| \frac{x+1}{x-1} \right)',
  # maple:      'pochhammer(alpha+1,n)/n!*pochhammer(-n,k)*pochhammer(n+alpha+beta+1,k)/pochhammer(alpha+1,k)/k!*((1-x)/2)^k',
  maple:      '1/2^n*binomial(n+alpha,k)*binomial(n+beta,n-k)*(x-1)^(n-k)*(x+1)^k',
  type:       'continuous',
  x_min:      -1,
  x_max:      1,
  position:   8
...
gegenbauer = Polynomial.new({
  ...
  definition: 'C_n^{(\alpha)}(x) = \frac{1}{\Gamma(\alpha)}\,\sum_{k=0}^{[n/2]} \frac{(-1)^k\,\Gamma(\alpha+n-k)}{k!\,(n-2k)!}\,(2x)^{n-2k} = {n+\alpha-1 \choose n} (2x)^n {}_2F_1 \left(\left. {-n/2, -n/2+\frac{1}{2} \atop -n-\alpha+1} \; \right| \frac{1}{x^2} \right)',
...
legendre = Polynomial.new({
  ...
  definition: 'P_n(x) = \frac{1}{2^n}\,\sum_{k=0}^{[n/2]} (-1)^k\,{n\choose k}\,{2n-2k\choose n}\,x^{n-2k} =  {2n \choose n} \left(\frac{x}{2}\right)^n {}_2F_1 \left(\left. {-n/2+\frac{1}{2}, -n/2 \atop -n+\frac{1}{2}} \; \right| \frac{1}{x^2} \right)',
...
chebyshevt = Polynomial.new({
  ...
  definition: 'T_n(x) = \frac{n}{2}\,\sum_{k=0}^{[n/2]} \frac{(-1)^k\,(n-k-1)!}{k!\,(n-2k)!}\,(2x)^{n-2k} = \frac{1}{2} (2x)^n {}_2F_1 \left(\left. {-n/2, -n/2+\frac{1}{2} \atop -n+1} \; \right| \frac{1}{x^2} \right)',
...
chebyshevu = Polynomial.new({
  ...
  definition: 'U_n(x) = \sum_{k=0}^{[n/2]} \frac{(-1)^k\,(n-k)!}{k!\,(n-2k)!}\,(2x)^{n-2k} = (2x)^n {}_2F_1 \left(\left. {-n/2, -n/2+\frac{1}{2} \atop -n} \; \right| \frac{1}{x^2} \right)',
...
meixner = Polynomial.new({
  ...
  definition: 'M_n(x;\beta,c) = {-\beta \choose n}^{-1} \sum_{k=0}^n {-\beta-x \choose n-k} {x \choose k} \left(\frac{1}{c}\right)^k  = {}_2F_1 \left(\left. {-n, -x \atop \beta} \; \right| 1-\frac{1}{c} \right)',
  # maple:      'pochhammer(-n,k)*pochhammer(-x,k)/pochhammer(beta,k)/k!*(1-1/c)^k',
  maple:      '1/binomial(-beta,n)*binomial(-beta-x,n-k)*binomial(x,k)*(1/c)^k',
  type:       'discrete',
  x_min:      0,
  x_max:      18,
  position:   13
...
krawtchouk = Polynomial.new({
  ...
  definition: 'K_n(x;p,N) = {N \choose n}^{-1} \sum_{k=0}^n {N-x \choose n-k} {x \choose k} \left(1-\frac{1}{p}\right)^k = {}_2F_1 \left(\left. {-n, -x \atop -N} \; \right| \frac{1}{p} \right)',
  # maple:      'pochhammer(-n,k)*pochhammer(-x,k)/pochhammer(-N,k)/k!*(1/p)^k',
  maple:      '1/binomial(N,n)*binomial(N-x,n-k)*binomial(x,k)*(1-1/p)^k',
  type:       'discrete',
  x_min:      0,
  x_max:      6,
  position:   14
...
laguerre = Polynomial.new({
  ...
  maple:      'binomial(n+alpha,n-k)/k!*(-x)^k',
  type:       'continuous',
  x_min:      -1,
  x_max:      16.5,
  position:   15
...
charlier = Polynomial.new({
  ...
  maple:      'binomial(n,k)*binomial(x,k)*k!*(-1/a)^k',
  type:       'discrete',
  x_min:      -0.25,
  x_max:      10.75,
  position:   16
